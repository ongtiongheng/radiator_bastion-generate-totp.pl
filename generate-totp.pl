...
my $random_hexstring ='';
$random_hexstring = unpack('H*', Bytes::Random::Secure::random_bytes(20)) if $algorithm eq 'SHA1' ;
$random_hexstring = unpack('H*', Bytes::Random::Secure::random_bytes(32)) if $algorithm eq 'SHA256';
$random_hexstring = unpack('H*', Bytes::Random::Secure::random_bytes(64)) if $algorithm eq 'SHA512';
